...
<h3>게시글 작성</h3>
<form action="updateLogic.do" method="post">
	<input type="hidden" name="idx" value="${ vo.idx }">
	<table border=1 cellpadding="5" cellspacing="0" align="center" width="640px" higth="400px">
		<tr>
			<th><font size="2px">제목</font></th>
			<td colspan="3">
				<input type="text" name="title" value="${ vo.title }" placeholder="Title input" maxlength="150" size="67" required>
			</td>
		</tr>
		<tr>
			<th><font size="2px">패스워드 사용</font><input type="checkbox" name="pw_check" onclick="checkbox_click()"></th>
			<td>
				<input type="password" name="pw" id="pw_input" value="${ vo.write_pw }" 
				placeholder="password input" maxlength="20" size="20" disabled required>
			</td>
		...
		<tr>
			<td colspan="4">
				<textarea rows="12" cols="85" name="context" style="resize:none;" required>${ vo.context }</textarea>
			</td>
		</tr>
	</table>
